...
public class WebSettingsConfigWriter implements ConfigWriter {
    ...
    public Map<String, String>  setConfigurationDefaults() {
        ...
        config.put("site.path", "http://localhost:8080");
        config.put("static.content.path", "http://localhost:8080");
        ...
        config.put("loader.dcr", "http://localhost:8080/dcr/v31/habbo.dcr?");
        config.put("loader.external.variables", "http://localhost:8080/dcr/v31/gamedata/external_variables.txt?");
        config.put("loader.external.texts", "http://localhost:8080/dcr/v31/gamedata/external_texts.txt?");

        config.put("loader.flash.base", "http://localhost:8080/gordon/RELEASE39-22643-22891-200911110035_07c3a2a30713fd5bea8a8caf07e33438/");
        config.put("loader.flash.swf", "http://localhost:8080/gordon/RELEASE39-22643-22891-200911110035_07c3a2a30713fd5bea8a8caf07e33438/Habbo.swf");
        config.put("loader.flash.external.texts", "http://localhost:8080/flash/gamedata/external_flash_texts.txt");
        config.put("loader.flash.external.variables", "http://localhost:8080/flash/gamedata/external_variables.txt");
        ...
        config.put("email.static.content.path", "http://localhost:8080");
